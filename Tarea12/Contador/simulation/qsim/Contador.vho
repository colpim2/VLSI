...
-- Design Ports Information
-- salMoore[0]	=>  Location: PIN_V5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salMoore[1]	=>  Location: PIN_W5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- salMoore[2]	=>  Location: PIN_V4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \salMoore[0]~output_o\ : std_logic;
SIGNAL \salMoore[1]~output_o\ : std_logic;
SIGNAL \salMoore[2]~output_o\ : std_logic;
...
\salMoore[0]~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
PORT MAP (
	i => present_state(0),
	devoe => ww_devoe,
	o => \salMoore[0]~output_o\);

-- Location: IOOBUF_X14_Y0_N2
\salMoore[1]~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
PORT MAP (
	i => present_state(1),
	devoe => ww_devoe,
	o => \salMoore[1]~output_o\);

-- Location: IOOBUF_X14_Y0_N16
\salMoore[2]~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
ww_salMoore(0) <= \salMoore[0]~output_o\;

ww_salMoore(1) <= \salMoore[1]~output_o\;

ww_salMoore(2) <= \salMoore[2]~output_o\;
END structure;
