...
-- Design Ports Information
-- F	=>  Location: PIN_F7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Mux0~0_combout\ = (\SEL[1]~input_o\ & (((\SEL[0]~input_o\)))) # (!\SEL[1]~input_o\ & ((\SEL[0]~input_o\ & ((\A[1]~input_o\))) # (!\SEL[0]~input_o\ & (\A[0]~input_o\))))
