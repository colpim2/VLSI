...
-- Design Ports Information
-- salsum	=>  Location: PIN_W3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- cout	=>  Location: PIN_U6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF sum1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \salsum~output_o\ : std_logic;
SIGNAL \cout~output_o\ : std_logic;
SIGNAL \a~input_o\ : std_logic;
SIGNAL \cin~input_o\ : std_logic;
SIGNAL \b~input_o\ : std_logic;
SIGNAL \salsum~0_combout\ : std_logic;
...
\salsum~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
\salsum~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \salsum~0_combout\ = \a~input_o\ $ (\cin~input_o\ $ (\b~input_o\))
